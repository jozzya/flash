...
namespace Drupal\flash\Composer;
...
final class AssetPackagist {
   ...
   * that contains a dependency on jozzya/flash.
   *
  ...
  protected static function getRootPackage() {
    ...
    do {
      if ($file->exists()) {
        ...
        if (isset($info['require']['jozzya/flash'])) {
          return $file;
        }
      }
      chdir('..');
  ...
  public static function execute(Event $event) {
    ...
    // Search upwards for a composer.json which depends on jozzya/flash.
    ...
    // oomphinc/composer-installers-extender is required by Flash and
